...
ol.proj.get("EPSG:31981").setExtent([773039.244664, 6911043.902380, 796423.821729, 6923328.754362]);
var wms_layers = [];
...
lyr_Curvas20_2.set('fieldLabels', {'fid': 'no label', 'ID': 'no label', 'ELEV': 'header label', });
...
lyr_ViasExistentes_11.set('fieldLabels', {'osm_id': 'no label', 'name': 'no label', 'highway': 'no label', 'waterway': 'no label', 'aerialway': 'no label', 'barrier': 'no label', 'man_made': 'no label', 'z_order': 'no label', 'other_tags': 'no label', });
lyr_TrechoDrenagem_12.set('fieldLabels', {'fid': 'no label', 'nome': 'no label', 'larguraMed': 'no label', 'nomeAbrev': 'header label', 'd_geometri': 'no label', 'd_coincide': 'header label', 'd_dentroDe': 'no label', 'd_regime': 'no label', });
